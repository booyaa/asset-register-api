...
namespace HomesEngland.Gateway.Test
{
    ...
    public class AssetAggregatorGatewayTests
    {
        ...
        [TestCase(2, 1, 1000.0001, 1001, null, null)]
        [TestCase(2, 1, 1000.0001, 2002, null, null)]
        [TestCase(2, 1, 1000.0001, 3003, null, null)]
        [TestCase(2, 2, 1000.0001, null, "test unique", "test")]
        [TestCase(2, 2, 1000.0001, null, "Test unique", "test")]
        [TestCase(2, 2, 1000.0001, null, "uniiique", "unii")]
        [TestCase(2, 2, 1000.0001, null, "testing 4", "tes")]
        [TestCase(2, 2, 1000.0001, null, "Testing 4", "tes")]
        [TestCase(2, 2, 1000.0001, null, "test uniQue", "que")]
        [TestCase(2, 2, 1000.0001, null, "uniiique", null)]
        [TestCase(2, 2, 1000.0001, null, " ", null)]
        [TestCase(2, 2, 1000.0001, null, "", null)]
        [TestCase(2, 2, 1000.0001, null, " ", " ")]
        [TestCase(2, 2, 1000.0001, null, "", "")]
        [TestCase(2, 2, 1000.0001, null, null, null)]
        [TestCase(2, 0, 1000.0001, null, "testing 4", "3")]
        [TestCase(2, 0, 1000.0001, null, "testing 4", "1")]
